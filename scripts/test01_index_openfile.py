...
class TestIndexOpenFile:
    ...
    @pytest.mark.parametrize("filedir, expect", read_yaml("test01_index_openfile.yaml"))
    def test_index_openfile(self, filedir, expect):
        try:
            # 打开文档组合业务方法(点击logo)
